...
{
	// Define a vector for the construction of the upper points of the bricks
	...
	brickVertices[11].normal = normalize(cross(vec3(brickVertices[3].coords - brickVertices[11].coords), vec3(brickVertices[10].coords - brickVertices[11].coords)));
